                ...
                <div>
                    <b-card class="p-3">
                      <div class="row no-gutters">
                        <div class="col-10">
                        <article data-transition="month-change" class="calendar-article">
                          <span class="calendar-article--text">{{ displayDate.format('Y') }}</span>
                        </article>
                        </div>
                        <div class="col-2">
                          <div class="row">
                            <button class="px-2">
                              <fa :icon="fas.faChevronUp" class="fa-sm" @click.stop.prevent="incrementYear($event, 1)"/>
                              <!-- <figure class="chevron up" @click.stop.prevent="incrementMonth($event, 1)"></figure> -->
                            </button>                            
                          </div>
                          <div class="row">
                            <button class="px-2">
                              <fa :icon="fas.faChevronDown" class="fa-sm" @click.stop.prevent="incrementYear($event, -1)"/>
                            </button>                             
                          </div>
                        </div>                         
                      </div>
                ...
                <div>
                    <b-card class="p-3">
                      <div class="row no-gutters">
                        <div class="col-10">
                        <article data-transition="month-change" class="calendar-article">
                          <span class="calendar-article--text">{{ displayDate.format('MMMM') }}</span>
                        </article>
                        </div>
                        <div class="col-2">
                          <div class="row">
                            <button class="px-2">
                              <fa :icon="fas.faChevronUp" class="fa-sm" @click.stop.prevent="incrementMonth($event, 1)"/>
                              <!-- <figure class="chevron up" @click.stop.prevent="incrementMonth($event, 1)"></figure> -->
                            </button>                            
                          </div>
                          <div class="row">
                            <button class="px-2">
                              <fa :icon="fas.faChevronDown" class="fa-sm" @click.stop.prevent="incrementMonth($event, -1)"/>
                            </button>                             
                          </div>
                        </div>                         
                      </div>
